...
@EnableJpaRepositories(basePackages = {"com.server.cms.repository"}, entityManagerFactoryRef = "oracleEntityManagerFactory", transactionManagerRef = "oracleTransactionManager")
public class OracleJpaDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean oracleEntityManagerFactory() {
        ...
        emf.setDataSource(oracleDataSourceProperties());
